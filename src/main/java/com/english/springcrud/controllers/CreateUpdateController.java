...
public class CreateUpdateController {
    ...
    public String createPhraseForm(@PathVariable(value = "first") String first,
    ...
    public String createPhrase(@PathVariable(value = "first") String first,
                               @PathVariable(value = "tense") String tense,
                               @PathVariable(value = "form") String form,
                               @Valid Phrase phrase,
    ...
    public String deletePhrase(@PathVariable(value = "first") String first,
    ...
    public String updatePhraseForm(@PathVariable(value = "first") String first,
